...
CREATE TABLE `shop type` (
  `idShop_type` int NOT NULL,
  `Type` tinytext,
  PRIMARY KEY (`idShop_type`)
...
INSERT INTO `shop type` VALUES (1,'Супермаркет'),(2,'Онлайн магазин'),(3,'Дискаунтер'),(4,'Гипермаркет'),(5,'Маркетплейс'),(6,'Торговая сеть');
